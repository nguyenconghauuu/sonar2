                            ...
                            <div class="box-body">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="u_phone" value="{{ old('u_phone') }}"  placeholder=" 0986.420.994" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="u_address" value="{{ old('u_address') }}"  placeholder=" Quận Đống Đa- Hà Nội " autocomplete="off">
