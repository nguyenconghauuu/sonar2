...
@section('title',' Thêm mới email hệ thống   ')
@section('main-content')
    <section class="content-header">
        <h1>
            Thêm mới email hệ thống 
        </h1>
    </section>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="text" class="form-control pull-right" name="e_drive" value="" autocomplete="off" value="{{ old('e_drive') }}" placeholder="smtp">
