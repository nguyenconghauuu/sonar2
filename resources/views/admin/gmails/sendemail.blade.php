...
@section('title',' Gủi email từ hệ thống   ')
@section('main-content')
    <section class="content-header">
        <h1>
            Gủi email từ hệ thống 
        </h1>
    </section>
                ...
                <div class="box box-primary">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="box-header with-border">
                            <h3 class="box-title">  Nội dung gủi gmail  </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="form-group clearfix">
                                <label for="inputEmail3" class="col-sm-2 control-label" style="text-align: right;margin-top: 8px"> Tiêu đề gủi gmail    </label>
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="text" class="form-control pull-right" name="" value="" autocomplete="off" value="{{ old('') }}" placeholder="Nhập tiêu đề gủi gmail ">
                            ...
                            <div class="form-group clearfix" style="margin-top: 10px;">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="text" class="form-control pull-right" name="e_host" autocomplete="off" value="{{ old('e_host') }}" placeholder="smtp.gmail.com">
                                        <div class="input-group-addon">
                                            <i class="fa fa-globe" style="width: 14px;"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group clearfix" style="margin-top: 10px;">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="number" class="form-control pull-right" name="e_post" value="" autocomplete="off" value="{{ old('e_post') }}" placeholder="456">
                                        <div class="input-group-addon">
                                            <i class="fa fa-globe" style="width: 14px;"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group clearfix" style="margin-top: 10px;">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="email" class="form-control pull-right" name="e_email" value="" autocomplete="off" value="{{  old('e_email') }}" placeholder="admin@gmail.com">
                                        <div class="input-group-addon">
                                            <i class="fa fa-globe" style="width: 14px;"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group clearfix" style="margin-top: 10px;">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="password" class="form-control pull-right" name="e_password"  autocomplete="off" placeholder="******">
                                        <div class="input-group-addon">
                                            <i class="fa fa-globe" style="width: 14px;"></i>
                                        </div>
                                    </div>
