        ...
        <div class="box">
            <div class="box-header border">
                ...
                <form action="" method="get" class="form-inline">
                    ...
                    <div class="" style="margin-top: 5px;display: inline-block">
                        <a href="{{ route('admin.post.about.add') }}" class="btn btn-xs btn-success"><i class="fa fa-plus"></i> Thêm mới </a>
                    </div>
                </form>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach($postAbout as $item)
                                <tr>
                                    <td>{{ $item->id }}</td>
                                    <td> {{ $item->po_title }}</td>
                                    <td>{!! renderHot(route('admin.post.about.hot',$item->id),$item->po_hot) !!}</td>
                                    {{--<td>--}}
...
{{--                                            <li><span style="display: inline-block;width: 23%">Active :</span>  {!! renderActive(route('admin.posts.active',$item->id),$item->po_active) !!}</li>--}}
                                    ...
                                    <td>
                                        {!! renderBtnEdit(route('admin.post.about.edit',$item->id)) !!}
                                        {!! renderBtnDelete(route('admin.post.about.delete',$item->id)) !!}
                                    </td>
                                </tr>
