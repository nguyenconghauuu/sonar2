                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="po_title" value="{{ old('po_title') }}"  placeholder="Tiêu đề bài viết không được quá 200 từ" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10" style="margin-right: 0;margin-left: 0">
                                            <textarea name="po_keywords"  cols="10" rows="3" class="form-control" placeholder="Dùng để seo nội dung , không quá 100 ký tự">{{ old('po_keywords') }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="po_hot" id="optionsRadios2" value="1" >
                                                    Có
                                                </label>
                                                <label>
                                                    <input type="radio" name="po_hot" id="optionsRadios1" value="0" checked="" >
                                                    Không
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="po_active" id="optionsRadios2" value="1"  checked="">
                                                    Có
                                                </label>
                                                <label>
                                                    <input type="radio" name="po_active" id="optionsRadios1" value="0"  >
                                                    Không
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="po_sort" value="{{ old('po_sort') }}" id="inputEmail3" placeholder=" Mặc định bằng 0" min="0" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group" style="margin:5px 0">
                                ...
                                <div class="col-sm-12" style="padding-left: 30px ;padding-right: 30px">
                                    <textarea name="po_content" id="my-editor" cols="10" rows="10" class="form-control" placeholder=" Mời bạn nhập nội dung bài viết ">{{ old('po_content') }}</textarea>
                            ...
                            <div class="" style="position: fixed;right: 15px;top: 50%;transform: translateY(-50%);">
                                ...
                                <a href=" {{ route('admin.post.about.index') }}" class="btn btn-danger btn-xs" style="width: 75px"> Huỷ bỏ </a>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
